...
public class ApartadoC extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Asigna al botón un evento para la salida de la ventana emergente
        button.setOnAction(e -> {
           ventanaEmergente("Título de ejemplo","Esto es un mensaje");
        });
    ...
    public static void ventanaEmergente(String titulo, String msg){
        // Crea la ventana emergente
        Stage popupWindow = new Stage();

        // Establece el título de la ventana emergente
        popupWindow.setTitle(titulo);
